...
const Chat = () => {
  ...
  return (
    isClicked.chat && (<div className="nav-item absolute right-5 md:right-52 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      <div className="flex justify-between items-center">
        ...
        <button
            type='button'
            onClick={() => setIsClicked((prev) => ({ ...prev, chat: false }))}           style={{
              colr: 'rgba(153, 171, 180)',
              borderRadius: '50%'
            }}
